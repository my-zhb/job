    ...
    public static function message($comment)
    {
        ...
        if (preg_match('/\{!\{(.*)\}!\}/', $comment['text'], $matches)) {
            ...
            if (Helper::options()->JTextLimit && strlen($comment['text']) > Helper::options()->JTextLimit) {
                ...
                /* 纯数字通过审核 */
                if (Helper::options()->CommentPass4Num === "on") {
                    if (is_numeric($comment['text'])) {
...
?>
        ...
        <script>
            window.JoeConfig = {
                ...
                canPreview: false,
                ZHINIAN_TUCHUANG_TOKEN: '<?php Helper::options()->TuChuangToken() ?>',
            }
        </script>
        <script src="https://cdn.jsdelivr.net/npm/aplayer@1.10.1/dist/APlayer.min.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/typecho-joe-next@6.2.4/plugin/prism/prism.min.js"></script>
        <script src="<?php Helper::options()->themeUrl('typecho/write/parse/parse.min.js') ?>"></script>
        <script src="<?php Helper::options()->themeUrl('typecho/write/dist/index.bundle.js?v=7.3.4') ?>"></script>
